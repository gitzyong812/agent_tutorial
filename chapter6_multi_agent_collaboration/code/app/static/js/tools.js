...
const ToolsPage = {
  ...
  row(tool) {
    ...
    const risk = `<span class="risk-badge risk-${tool.risk_level}">${App.t(`risk_${tool.risk_level}`)}</span>`;
    ...
    mask.innerHTML = `
      <div class="modal">
        ...
        <div class="modal-body"><div class="form-grid">
          ...
          <div class="field"><label>${App.t("tools_risk")}</label><select id="t-risk">
            <option value="read" ${d.risk_level === "read" ? "selected" : ""}>${App.t("risk_read")}</option>
            <option value="write" ${d.risk_level === "write" ? "selected" : ""}>${App.t("risk_write")}</option>
            <option value="restricted" ${d.risk_level === "restricted" ? "selected" : ""}>${App.t("risk_restricted")}</option>
          </select></div>
    ...
    mask.querySelector("#t-save").onclick = async () => {
      try {
        const payload = {
          ...
          risk_level: mask.querySelector("#t-risk").value,
        };
