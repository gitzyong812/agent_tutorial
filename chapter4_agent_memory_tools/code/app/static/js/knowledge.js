  ...
  async render() {
    ...
    page.innerHTML = `
      <div class="list-page">
        ...
        <div class="k-toolbar">
          <input id="k-keyword" placeholder="${escapeAttr(App.t("knowledge_search_ph"))}" value="${escapeAttr(this.keyword)}">
        ...
        <div class="modal-body">
          <div class="form-grid">
            ...
            <div class="form-grid cols-2">
              <div class="field"><label>${App.t("knowledge_source")}</label><input id="f-source" value="${escapeAttr(d.source)}"></div>
              <div class="field"><label>${App.t("knowledge_version")}</label><input id="f-version" value="${escapeAttr(d.version)}"></div>
            </div>
