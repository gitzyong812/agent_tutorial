...
图[8-3](#fig-ch8-workbuddy-expert-center)展示了 WorkBuddy 的专家中心。界面上方按照开学季、内容创作、投资分析、法律咨询和小微企业等业务场景提供预制方案，下方则列出可以单独使用的专家。用户可以先从业务场景或岗位能力出发选择，而不必从模型参数和工作流节点开始配置。

<a id="fig-ch8-workbuddy-expert-center"></a>

![WorkBuddy 专家中心中的预制场景与专家](./workbuddy_demo.png)

*图 8-3　WorkBuddy 专家中心中的预制场景与专家*

这些界面元素可以与本书概念建立对应关系。单个“专家”对应前文的数字员工，它包含相对稳定的角色、任务方法、技能和工具。“专家团”对应第 6 章的多智能体团队，也对应一人公司中的数字专家团队。团长承担任务拆解、分配和结果汇总，多个专家分别完成专业子任务。“技能”和“连接器”则对应智能体可复用的工作方法、工具及外部系统接口。预制场景是在这些基本元素之上形成的业务模板，它把常见任务、角色组合和交付方式组织成可以直接使用的起点。

从商业化软件设计角度看，这种产品形态体现了三个思路：

1. **面向企业生产力和业务流程。**系统围绕任务、资料、协作过程和工作成果组织能力，而不是只提供一次问答。
1. **通过直观界面和预制方案降低使用成本。**用户可以选择已有专家或专家团，再根据具体业务调整资料和要求，减少从零配置带来的学习和维护负担。
1. **支持生产环境中的多智能体扩展。**专家、技能、连接器和团队采用相对标准化的配置后，可以在不同任务中复用，并逐步扩展到更多部门和业务流程。

这些思路说明了商业软件如何把模型能力封装为更容易采用的业务产品，但预制方案并不等于可以直接投入生产。正式使用时仍需检查事实来源、数据权限、工具风险、运行日志、成本和人工接管机制。平台的规模化能力也应通过真实任务和稳定性测试验证。
