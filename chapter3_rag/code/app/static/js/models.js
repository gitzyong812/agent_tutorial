    ...
    mask.innerHTML = `
      <div class="modal">
        ...
        <div class="modal-body">
          <div class="form-grid">
            <div class="field"><label>${App.t("field_name")}</label><input id="f-name" value="${escapeHtml(f.name)}"></div>
            <div class="form-grid cols-2">
              <div class="field"><label>${App.t("field_provider")}</label><input id="f-provider" value="${escapeHtml(f.provider)}"></div>
              <div class="field"><label>${App.t("field_model_name")}</label><input id="f-model" value="${escapeHtml(f.model_name)}"></div>
            </div>
            <div class="field"><label>${App.t("field_base_url")}</label><input id="f-url" value="${escapeHtml(f.base_url)}"></div>
            <div class="field"><label>${App.t("field_api_key")}</label><input id="f-key" value="${escapeHtml(f.api_key)}"></div>
          </div>
        </div>
